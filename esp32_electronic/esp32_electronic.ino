...
EspMQTTClient client(
  ...
  "electronic",     // Client name that uniquely identify your device
...
void onConnectionEstablished()
{
  ...
  client.subscribe("ha/esp/electronic", [](const String & payload) {
    Serial.println(payload);
    if (payload=="on")
    {
      digitalWrite(32,HIGH);
      //client.publish("ha/esp/state/electronic","on");
    }
    if (payload=="off")
    {
      digitalWrite(32,LOW);
